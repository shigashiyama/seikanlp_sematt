...
class AttributeAnnotatorArgumentLoader(ArgumentLoader):
    def get_full_parser(self):
        ...
        parser.add_argument('--k_best', '-k', type=int, default=1, help='value K for K-best output')
    ...
    def get_minimum_parser(self, args):
        ...
        parser.add_argument('--k_best', '-k', type=int, default=args.k_best, help='value K for K-best output')
    ...
    def add_input_data_format_option(self, parser, args):
        if args.execute_mode == 'interactive':
            ...
            if args.input_data_format == 'wl' or not args.input_data_format:
